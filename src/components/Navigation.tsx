...
const Navigation = ({ activeTab, onTabChange }: NavigationProps) => {
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 bg-card/95 backdrop-blur-md border-t border-border/50 p-4 z-50 pb-[calc(1rem+env(safe-area-inset-bottom))]">
