...
const HeroSection = ({ onNavigate }: HeroSectionProps) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-hero">
            ...
            <div className="mt-12 md:mt-0 relative">
              <div className="relative mx-auto md:mx-0 max-w-sm md:max-w-md">
                <img 
                  ...
                  className="w-full rounded-2xl shadow-ar-glow border border-primary/20"
                />
                <div className="absolute -top-4 -right-4 w-8 h-8 bg-ar-green rounded-full animate-pulse shadow-ar-glow"></div>
      ...
      {/* Demo Section */}
      <div className="px-4 py-16 bg-gradient-to-b from-transparent to-muted/30">
        <div className="text-center mb-12">
          <h2 className="text-2xl font-bold text-foreground mb-4">
            See It In Action
          </h2>
          ...
          <CardContent className="p-8">
            ...
            <div className="flex gap-3">
              <Button 
                variant="secondary" 
                size="lg" 
                className="flex-1 bg-white/20 hover:bg-white/30 transition-smooth"
                onClick={() => onNavigate('scanner')}
              >
              ...
              <Button 
                variant="secondary" 
                size="lg"
                className="bg-white/20 hover:bg-white/30 transition-smooth"
