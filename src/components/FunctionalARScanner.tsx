...
import { Camera, Zap, Thermometer, Droplets, Sun, AlertCircle, Save, History, MapPin, Maximize, Layers } from "lucide-react";
      ...
      <div className="relative h-96 mx-4 mt-4 rounded-xl overflow-hidden bg-muted/30">
        ...
        {(cameraActive || capturedImage) && (
          <div className="absolute inset-0">
            ...
            {!isScanning && !spaceScanning && capturedImage && scanMode === 'plant' && detectedPlant && (
              <>
